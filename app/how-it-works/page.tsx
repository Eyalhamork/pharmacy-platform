...
export const metadata: Metadata = {
  title: 'How It Works | Lucky Pharmacy',
  description: 'Learn how to order medications online from Lucky Pharmacy. Simple steps from browsing to delivery at your doorstep.',
};
