...
export const metadata: Metadata = {
  title: 'About Us | MoPharma',
  description: 'Learn about MoPharma - Your trusted online pharmacy in Liberia, committed to making healthcare accessible and affordable for everyone.',
};
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-lg text-gray-600 space-y-4">
            <p>
              MoPharma was born out of a simple observation: accessing quality 
            ...
            <p>
              ...
              MoPharma combines pharmaceutical expertise with modern e-commerce 
            ...
            <p>
              Today, MoPharma serves customers across Monrovia and beyond, with plans 
      ...
      <div className="bg-gradient-to-br from-green-600 to-green-700 text-white py-12">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-center mb-12">MoPharma by the Numbers</h2>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-gray-600 mb-6">
              MoPharma is fully licensed by the Liberia Medicines & Health Products 
