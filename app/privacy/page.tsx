...
export const metadata: Metadata = {
  title: 'Privacy Policy | MoPharma',
  description: 'Learn how MoPharma collects, uses, and protects your personal information. Your privacy and data security are our priorities.',
};
        ...
        <div className="max-w-4xl mx-auto space-y-12">
            ...
            <Card>
              <CardContent className="p-8">
                <p className="text-gray-600 leading-relaxed">
                  MoPharma ("we," "our," or "us") is committed to protecting your privacy and 
                  ...
                  services. By using MoPharma, you agree to the collection and use of information 
              ...
              <CardContent className="p-8">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      If MoPharma is acquired or merged, your information may be transferred to 
            ...
            <Card>
              <CardContent className="p-8">
                ...
                <p className="text-sm text-gray-500 mt-6">
                  To exercise any of these rights, contact us at info@mopharma.com or through 
          ...
          <div>
            ...
            <Card>
              <CardContent className="p-8">
                <p className="text-gray-600">
                  MoPharma is not intended for use by individuals under 18 years of age. We do 
            ...
            <Card>
              <CardContent className="p-8">
                <p className="text-gray-600">
                  ...
                  MoPharma after changes constitutes acceptance of the updated policy.
                </p>
              </CardContent>
            </Card>
          </div>
          ...
          <Card className="bg-gradient-to-r from-green-600 to-green-700 text-white">
            <CardContent className="p-8">
              ...
              <div className="space-y-2 text-green-50">
                <p><strong>Email:</strong> privacy@mopharma.com</p>
