...
export const metadata: Metadata = {
  title: 'Contact Us | MoPharma',
  description: 'Get in touch with MoPharma. We\'re here to help with your questions, orders, and pharmaceutical needs.',
};
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">
                          info@mopharma.com<br />
                          support@mopharma.com
                        </p>
                      </div>
                    </div>
                  </CardContent>
