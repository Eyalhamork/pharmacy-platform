...
export const metadata: Metadata = {
  title: 'Shipping & Delivery | MoPharma',
  description: 'Learn about MoPharma\'s delivery options, zones, fees, and timelines. Fast, reliable delivery across Monrovia and beyond.',
};
